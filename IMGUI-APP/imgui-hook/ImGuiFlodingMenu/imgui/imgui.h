...
namespace ImGui
{
    ...
    IMGUI_API void          FunctionItem(const char* title,const int color, const int bg_color,ImVec2 padding,bool open, bool selected);
    IMGUI_API void          Function(const char* title, const int color, const int bg_color, ImVec2 padding, bool open, bool selected);
    IMGUI_API void          Gap();
